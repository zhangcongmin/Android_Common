...
/**
 * @author weibin  chen
 * @since 2019/3/16 10:37
 */
public class MaxGridItemDecoration extends RecyclerView.ItemDecoration {
    private Paint mVerPaint, mHorPaint;
    private Builder mBuilder;


    MaxGridItemDecoration(Builder builder) {
        init(builder);
    }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        int top =0;
        if(mBuilder.isShowFirstDivider) {
            boolean isFirstRow = isFirstRow(parent, itemPosition, spanCount, childCount);
            top = isFirstRow ? mBuilder.dividerHorSize : 0;
        }
    ...
    public static class Builder {
        ...
        boolean isShowFirstDivider = true;
        ...
        public MaxGridItemDecoration build() {
            return new MaxGridItemDecoration(this);
        }

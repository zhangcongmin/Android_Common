...
//        init();
    ...
    public void setIconVisibility(boolean visibility) {
        ...
        for (BottomNavigationItemView button : mButtons) {
            ...
            // 4. set mIcon visibility gone
            mIcon.setVisibility(visibility ? VISIBLE : INVISIBLE);
        }
...
//            System.out.println("mLargeLabel.getMeasuredHeight():" + getFontHeight(mSmallLabelSize));
    ...
    public void enableAnimation(boolean enable) {
        ...
        for (BottomNavigationItemView button : mButtons) {
            TextView mLargeLabel = getField(button.getClass(), button, "largeLabel");
            TextView mSmallLabel = getField(button.getClass(), button, "dmallLabel");
...
//        getBottomNavigationItemView(position).setShifting(false);
    }
